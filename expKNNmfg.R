...
# args = c(1, "rv", "ed", "1", "rs", "3", "svm")
# args = c("61", "nv", "ip", "3", "df",  "5", "J48")
# args = c("61", "nv", "ip", "3", "rs",  "5", "svm")
...
if(length(args) != 7) {
  stop("Please, provide all the seven args:\n <1:256> <rv-nv> <ed-ip-cs-pc> <1:3> <pso-rs-df-smbo> <3-5-10> <svm-J48>")
}
