...
# args = c("in", 10, "qu", 5, "ed", 1, "pso", 3, "nv", "svm")
# args = c("in", 10, "qu", 5, "ed", 1, "df", 3, "nv", "J48")
...
if(length(args) != 10) {
  stop("Please, provide all the ten args:\n <in-ex> <-10:10> <qu-hi> <5,10,20> <ed-ip-cs-pc> <1-2-3> <pso-rs-df-smbo> <3-5-10> <rv-nv> <svm-J48>")
}
...
cat(" ========================================== \n")
cat(" * Running expKNNpqh with following parameters: \n")
